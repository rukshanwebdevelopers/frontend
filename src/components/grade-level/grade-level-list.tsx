...
import { Course, GradeLevel, SortOrder } from '@/types';
    ...
    },
    {
      title: (
        <TitleWithSort
          ...
          ascending={
            sortingObj.sort === SortOrder.Asc && sortingObj.column === 'level'
          }
          isActive={sortingObj.column === 'level'}
        />
      ),
      className: 'cursor-pointer',
      dataIndex: 'level',
      ...
      align: alignLeft,
      width: 150,
      onHeaderCell: () => onHeaderClick('level'),
    },
    {
      ...
      align: alignRight,
      width: 120,
      render: (slug: string, record: GradeLevel) => (
        <LanguageSwitcher
          slug={slug}
          record={record}
