...
const AnalyticCard = ({
  ...
  return (
    <div
      className="flex h-full w-full flex-col rounded-lg border border-b-2 border-border-200 bg-light p-5 md:p-6"
    ...
    >
      <div className="mb-auto flex w-full items-center justify-between">
        ...
        <div className="flex w-full flex-col">
          <span className="mb-1 text-sm font-normal text-body">
            {t(titleTransKey)}
          </span>
